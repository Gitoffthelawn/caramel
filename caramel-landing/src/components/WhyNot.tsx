            ...
            <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
                ...
                >
                    ...
                    <p className="text-xl lg:text-lg text-gray-600 dark:text-gray-300 max-w-4xl mx-auto leading-relaxed mb-8">
                        Reports show <span className="text-red-600 font-semibold">Honey and many other extensions override affiliate links</span> — cutting creators' revenue and your savings. <span className="text-caramel font-semibold">Caramel is the transparent, open-source fix.</span> <span className="font-semibold">Watch why →</span>
                    </p>
                ...
                >
                    ...
                    <p className="text-lg opacity-90 mb-8 max-w-3xl mx-auto leading-relaxed">
                        Join thousands of users who've made the switch to Caramel. Save money while supporting the creators you love, all with complete transparency and privacy protection.
                    </p>
