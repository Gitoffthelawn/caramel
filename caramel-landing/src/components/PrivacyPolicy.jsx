        ...
        <div className="scroller container overflow-x-auto p-8 sm:px-0">
            <div className="relative flex items-center">
                <div className="absolute left-0 top-0">
                    <TbListCheck className="text-3xl text-black" />
                </div>
                <h1 className="mb-6 pl-10 text-3xl font-bold text-black sm:text-xl">
                    Privacy Policy
                </h1>
            </div>
            ...
            <div className="space-y-6">
                <div className="text-black font-semibold">
                    Effective Date: <span className="text-gray-700">01/01/2025</span>
                </div>
                ...
                <p className="ml-6 text-black sm:ml-2">
