...
// The notched-ticket geometry factory + the Perforation/PercentEmblem meshes
// + the caramel palette all live in ./couponTicket3d (shared with the compact
// hero scene) so the silhouette has ONE codepath.
