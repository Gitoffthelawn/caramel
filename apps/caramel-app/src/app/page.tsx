...
// empty shell. Nothing client-only may be called HERE: useSearchParams at
// page level opts the entire route out of server rendering. (`/?error=` from
// better-auth is handled before the page renders, by next.config's redirect.)
